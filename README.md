...
eshbot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running eshbot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start eshbot locally by running:
...
Then you can interact with eshbot by typing `eshbot help`.

    eshbot> eshbot help
    eshbot animate me <query> - The same thing as `image me`, except adds [snip]
    eshbot help - Displays all of the help commands that eshbot knows about.
    ...
